		...
		<div className="mt-16 min-h-screen bg-background text-foreground flex flex-col items-center justify-center">
			...
			<section className="text-center p-6">
				...
				<p className="text-muted-foreground text-lg mb-8">
					Streamline peer evaluations for CS 3240 at UVA. Students review their teammates after each sprint, and professors monitor progress
					effortlessly.
				</p>
			...
			{/* Footer */}
			<footer className="w-full mt-auto py-6 bg-muted text-muted-foreground text-center">© 2024 PeerReview | CS 3240 | University of Virginia</footer>
		</div>
	)
}
